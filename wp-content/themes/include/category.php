							...
							<ul class="list-unstyled">
								<?php while (have_posts()) : the_post(); ?>
									<a href="<?php the_permalink(); ?>">
										<li class="media">
											<img src="<?php echo (the_post_thumbnail_url()) ? the_post_thumbnail_url() : get_field('post_thumb'); ?>" class="img-fluid" alt="<?php echo get_the_title(); ?>">
